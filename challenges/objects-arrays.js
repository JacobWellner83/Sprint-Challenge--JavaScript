...
*/
const largerPopulation = zooAnimals.filter((smallPopulation) => {
  return smallPopulation.population < 5;
})
...
*/
let populationTotal = [];
populationTotal = zooAnimals.reduce((total, amountNow) => total + amountNow.population, 0)
...
*/
//Array methods partially converted.
